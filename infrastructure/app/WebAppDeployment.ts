...
export class WebAppDeployment {
    ...
    private initialize(){
        const bucketName = 'blog-app-web' + this.bucketSuffix;

        this.deploymentBucket = new Bucket(this.stack, 'blog-app-web-id', {
            bucketName: bucketName,
            publicReadAccess: true,
            websiteIndexDocument: 'index.html'
        });

        new BucketDeployment(this.stack, 'blog-app-web-id-deployment', {
        ...
        new CfnOutput(this.stack, 'blogAppS3Url', {
            value: this.deploymentBucket.bucketWebsiteUrl
        });

        const cloudFront = new CloudFrontWebDistribution(this.stack, 'blog-app-web-distribution', {
            originConfigs: [
                {
                    behaviors: [
                        {
        ...
        new CfnOutput(this.stack, 'blogWebAppCloudFrontUrl', {
